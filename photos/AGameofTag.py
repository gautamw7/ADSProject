...
star_images = {
    '3': pygame.transform.scale(pygame.image.load('photos/star3.png'), (100, 50)),
    '2': pygame.transform.scale(pygame.image.load('photos/star2.png'), (100, 50)),
    '1': pygame.transform.scale(pygame.image.load('photos/star1.png'), (100, 50)),
    '0': pygame.transform.scale(pygame.image.load('photos/star0.png'), (100, 50))
}
